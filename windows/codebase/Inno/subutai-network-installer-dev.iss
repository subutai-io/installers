...
[Run]
Filename: "{app}\bin\{#MyAppExeName}"; Parameters: "{#MyAppType} repomd5-dev Run {#kurjunURL}"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent  runascurrentuser
